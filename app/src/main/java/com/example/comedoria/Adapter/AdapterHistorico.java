...
public class AdapterHistorico extends RecyclerView.Adapter<AdapterHistorico.MyViewHolder> {
    ...
    // Método chamado para criar novas visualizações de itens do histórico de pedidos
    @NonNull
    @Override
    public AdapterHistorico.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Infla o layout do item do histórico de pedidos
        View itemLista = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_historico, parent, false);
        return new AdapterHistorico.MyViewHolder(itemLista);
    }

    // Método chamado para preencher os dados de um item do histórico de pedidos na visualização
    @Override
    public void onBindViewHolder(@NonNull AdapterHistorico.MyViewHolder holder, int position) {
        ...
        // Se o status for "Retirado", altera a cor do texto para verde
        if(pedido.getStatus().equals("Retirado")){
            holder.txtStatus.setTextColor(Color.parseColor("#ff669900"));
        }

        // Determina a largura fixa do Status
        ...
        // Determina a largura fixa do Total
        ...
        // Adiciona um ouvinte de clique ao item do histórico de pedidos para visualizar detalhes do pedido
    ...
    // Método chamado para obter o número total de itens no histórico de pedidos
    @Override
    public int getItemCount() {
        return historico.size();
    }

    // Classe ViewHolder para representar os itens do histórico de pedidos na visualização
